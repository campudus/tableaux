...
class TableDisplayNamesTest extends TableauxTestBase {
  ...
  @Test
  def createRegularTableWithoutDisplayName(implicit c: TestContext): Unit = okTest {
  ...
  @Test
  def createRegularTableWithMultipleDisplayNames(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj(
      "name" -> "sometable",
  ...
  @Test
  def createRegularTableWithSingleDisplayName(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj(
      "name" -> "sometable",
  ...
  @Test
  def updateTableNameDoesNotChangeDisplayNames(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj(
      "name" -> "sometable",
      "displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")
    )
  ...
  @Test
  def updateTableNameDoesNotAddDisplayNames(implicit c: TestContext): Unit = okTest {
  ...
  @Test
  def updateTableAndAddDisplayNames(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj("name" -> "sometable")
    ...
    val expectedAfterUpdate = baseExpected.copy().mergeIn(Json.obj("displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")))
  ...
  @Test
  def updateDisplayNames(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj(
      "name" -> "sometable",
      "displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")
    )
    ...
    val expectedAfterCreate = baseExpected.copy().mergeIn(Json.obj("displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")))
    val expectedAfterUpdate = baseExpected.copy().mergeIn(Json.obj("displayName" -> Json.obj("de-DE" -> "Immer noch eine Tabelle", "en-GB" -> "Some table")))
  ...
  @Test
  def deleteDisplayName(implicit c: TestContext): Unit = okTest {
    val createTableJson = Json.obj(
      "name" -> "sometable",
      "displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")
    )
    ...
    val expectedAfterCreate = baseExpected.copy().mergeIn(Json.obj("displayName" -> Json.obj("de-DE" -> "Eine Tabelle", "en-GB" -> "Some table")))
    val expectedAfterUpdate = baseExpected.copy().mergeIn(Json.obj("displayName" -> Json.obj("en-GB" -> "Some table")))
